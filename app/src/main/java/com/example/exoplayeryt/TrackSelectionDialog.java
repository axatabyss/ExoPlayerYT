...
public final class TrackSelectionDialog extends DialogFragment {
  ...
  public static final class TrackSelectionViewFragment extends Fragment
    ...
    public View onCreateView(
      ...
      View rootView =
              inflater.inflate(
                      R.layout.exo_track_selection_dialognew, container, /* attachToRoot= */ false);
      @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TrackSelectionView trackSelectionView = rootView.findViewById(R.id.exo_track_selection_view);
